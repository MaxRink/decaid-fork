...
void main() {
  ...
  late DosingScaleController dosing;
  ...
  setUp(() async {
    ...
    dosing = DosingScaleController();
    await dosing.connectToScale(TestScale(deviceId: 'dose-scale'));
  ...
  test(
    ...
    () async {
      ...
      expect(connectionJson['dosing']['deviceId'], 'dose-scale');
  ...
  test('rejects dosing and full gateway guarded machine actions', () async {
